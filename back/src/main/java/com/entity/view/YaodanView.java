...
*/
@TableName("yaodan")
public class YaodanView extends YaodanEntity implements Serializable {
	...
	*/
	...
	public YaodanView(YaodanEntity yaodanEntity) {
		try {
			BeanUtils.copyProperties(this, yaodanEntity);
