...
public class YayiOrderView extends YayiOrderEntity implements Serializable {
	...
	*/
	...
	private String yayiOrderYuyueValue;
	/**
	* 预约状态的值
	*/
	@ColumnInfo(comment="预约状态的字典表值",type="varchar(200)")
	private String yayiOrderValue;
	...
	public YayiOrderView() {

	}

	public YayiOrderView(YayiOrderEntity yayiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, yayiOrderEntity);
	...
	* 获取： 预约类型的值
	*/
	public String getYayiOrderYuyueValue() {
		return yayiOrderYuyueValue;
	}
	/**
	* 设置： 预约类型的值
	*/
	public void setYayiOrderYuyueValue(String yayiOrderYuyueValue) {
		this.yayiOrderYuyueValue = yayiOrderYuyueValue;
	}
	//当前表的
	/**
	* 获取： 预约状态的值
	*/
	public String getYayiOrderValue() {
		return yayiOrderValue;
	}
	/**
	* 设置： 预约状态的值
	*/
	public void setYayiOrderValue(String yayiOrderValue) {
		this.yayiOrderValue = yayiOrderValue;
	}
	...
	public String toString() {
		return "YayiOrderView{" +
			", yayiOrderYuyueValue=" + yayiOrderYuyueValue +
			", yayiOrderValue=" + yayiOrderValue +
