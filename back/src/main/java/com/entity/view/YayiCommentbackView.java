...
public class YayiCommentbackView extends YayiCommentbackEntity implements Serializable {
	...
	public YayiCommentbackView() {

	}

	public YayiCommentbackView(YayiCommentbackEntity yayiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, yayiCommentbackEntity);
