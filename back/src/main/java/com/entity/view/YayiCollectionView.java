...
public class YayiCollectionView extends YayiCollectionEntity implements Serializable {
	...
	*/
	...
	private String yayiCollectionValue;
	...
	public YayiCollectionView() {

	}

	public YayiCollectionView(YayiCollectionEntity yayiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yayiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getYayiCollectionValue() {
		return yayiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setYayiCollectionValue(String yayiCollectionValue) {
		this.yayiCollectionValue = yayiCollectionValue;
	}
	...
	public String toString() {
		return "YayiCollectionView{" +
			", yayiCollectionValue=" + yayiCollectionValue +
