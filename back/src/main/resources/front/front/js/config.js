...
var centerMenu = [
    ...
    ,{
        name: '牙医收藏',
        url: '../yayiCollection/list.html'
    }
    ,{
        name: '牙医挂号',
        url: '../yayiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '牙医',
        url: './pages/yayi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/yakejiuzhenguanli/admin/dist/index.html#/login";
