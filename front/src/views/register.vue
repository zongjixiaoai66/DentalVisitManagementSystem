    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">牙科就诊管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="牙医编号" class="input" v-if="tableName=='yayi'">
                                <el-input v-model="ruleForm.yayiUuidNumber" autocomplete="off" placeholder="牙医编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="牙医姓名" class="input" v-if="tableName=='yayi'">
                            <el-input v-model="ruleForm.yayiName" autocomplete="off" placeholder="牙医姓名"  />
                        </el-form-item>
                        <el-form-item label="牙医手机号" class="input" v-if="tableName=='yayi'">
                            <el-input v-model="ruleForm.yayiPhone" autocomplete="off" placeholder="牙医手机号"  />
                        </el-form-item>
                        <el-form-item label="牙医身份证号" class="input" v-if="tableName=='yayi'">
                            <el-input v-model="ruleForm.yayiIdNumber" autocomplete="off" placeholder="牙医身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="yayiPhotoFlag">
                            </el-form-item>
                            <el-form-item label="牙医头像" class="input" v-if="tableName=='yayi'">
                                    <file-upload
                                        tip="点击上传牙医头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="牙医邮箱" class="input" v-if="tableName=='yayi'">
                            <el-input v-model="ruleForm.yayiEmail" autocomplete="off" placeholder="牙医邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="挂号费用" class="input" v-if="tableName=='yayi'">
                                <el-input v-model="ruleForm.newMoney" autocomplete="off" placeholder="挂号费用"  />
                           </el-form-item>
                        -->
                       <!--<el-form-item class="input" label="职位">
                        ...
                        <!--
                            <el-form-item label="医生介绍" class="input" v-if="tableName=='yayi'">
                                <el-input type="textarea" v-model="ruleForm.yayiContent" placeholder="医生介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="擅长" class="input" v-if="tableName=='yayi'">
                                <el-input type="textarea" v-model="ruleForm.yayiShanchangContent" placeholder="擅长"></el-input>
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="所获荣誉" class="input" v-if="tableName=='yayi'">
                                <el-input type="textarea" v-model="ruleForm.yayiRongyuContent" placeholder="所获荣誉"></el-input>
                           </el-form-item>
                        -->
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        <!--
                            <el-form-item label="创建时间 show1 show2 nameShow" class="input" v-if="tableName=='yayi'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间 show1 show2 nameShow"  />
                           </el-form-item>
                        -->
                        <!--
        ...
        methods: {
            ...
            yayiPhotoUploadChange(fileUrls) {
               this.ruleForm.yayiPhoto = fileUrls;
                if(this.yayiPhotoFlag){
                    this.yayiPhotoFlag=false;
                }else{
                    this.yayiPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // yayi 中的 牙医编号 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.yayiUuidNumber== null ||this.ruleForm.yayiUuidNumber== "")){
                            //     this.$message.error("牙医编号不能为空");
                            //     return
                            // }
                            if((!this.ruleForm.yayiName)&& 'yayi'==this.tableName){
                                this.$message.error('牙医姓名不能为空');
                                return
                            }
                             if('yayi' == this.tableName && this.ruleForm.yayiPhone&&(!this.$validate.isMobile(this.ruleForm.yayiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.yayiIdNumber)&& 'yayi'==this.tableName){
                                this.$message.error('牙医身份证号不能为空');
                                return
                            }
                            // yayi 中的 牙医头像 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.yayiPhoto== null ||this.ruleForm.yayiPhoto== "")){
                            //     this.$message.error("牙医头像不能为空");
                            //     return
                            // }
                            if('yayi' == this.tableName && this.ruleForm.yayiEmail&&(!this.$validate.isEmail(this.ruleForm.yayiEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // yayi 中的 挂号费用 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
                            //     this.$message.error("挂号费用不能为空");
                            //     return
                            // }
                            // yayi 中的 职位 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.zhiweiTypes== null ||this.ruleForm.zhiweiTypes== "")){
                            //     this.$message.error("职位不能为空");
                            //     return
                            // }
                            // yayi 中的 医生介绍 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.yayiContent== null ||this.ruleForm.yayiContent== "")){
                            //     this.$message.error("医生介绍不能为空");
                            //     return
                            // }
                            // yayi 中的 擅长 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.yayiShanchangContent== null ||this.ruleForm.yayiShanchangContent== "")){
                            //     this.$message.error("擅长不能为空");
                            //     return
                            // }
                            // yayi 中的 所获荣誉 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.yayiRongyuContent== null ||this.ruleForm.yayiRongyuContent== "")){
                            //     this.$message.error("所获荣誉不能为空");
                            //     return
                            // }
                            // yayi 中的 账户状态 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
                            // yayi 中的 创建时间 show1 show2 nameShow 判空处理
                            // if('yayi' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            //     this.$message.error("创建时间 show1 show2 nameShow不能为空");
                            //     return
                            // }
                            // yonghu 中的 用户编号 判空处理
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yakejiuzhenguanli/img/back-img-bg.jpg);
