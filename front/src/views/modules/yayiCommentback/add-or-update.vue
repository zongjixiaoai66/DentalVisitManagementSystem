    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="yayiCommentbackText">
                        <el-input type="textarea"  :readonly="ro.yayiCommentbackText" v-model="ruleForm.yayiCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yayiCommentbackText" label="评价内容" prop="yayiCommentbackText">
                            <span v-html="ruleForm.yayiCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.yayiId = true;//牙医
                this.ro.yonghuId = true;//用户
                this.ro.yayiCommentbackText = true;//评价内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yayiCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yayiCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
