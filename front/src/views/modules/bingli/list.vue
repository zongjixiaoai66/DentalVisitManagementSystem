        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '病人名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.bingrenName" placeholder="病人名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yakejiuzhenguanli/upload/bingliMuBan.xls"
                        >批量导入病例数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('bingli','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                sexTypes : null,
                age : null,
                bingliZhusuContent : null,
                bingliXianbingshiContent : null,
                bingliJiwangshiContent : null,
                bingliTijianjieguoContent : null,
                bingliFuzhujieguoContent : null,
                bingliChubuzhenduanContent : null,
                bingliZhiliaoyijianContent : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
