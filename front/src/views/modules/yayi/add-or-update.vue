    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牙医编号" prop="yayiUuidNumber">
                       <el-input v-model="ruleForm.yayiUuidNumber"
                                 placeholder="牙医编号" clearable  :readonly="ro.yayiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牙医姓名" prop="yayiName">
                       <el-input v-model="ruleForm.yayiName"
                                 placeholder="牙医姓名" clearable  :readonly="ro.yayiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牙医手机号" prop="yayiPhone">
                       <el-input v-model="ruleForm.yayiPhone"
                                 placeholder="牙医手机号" clearable  :readonly="ro.yayiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牙医身份证号" prop="yayiIdNumber">
                       <el-input v-model="ruleForm.yayiIdNumber"
                                 placeholder="牙医身份证号" clearable  :readonly="ro.yayiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="牙医邮箱" prop="yayiEmail">
                       <el-input v-model="ruleForm.yayiEmail"
                                 placeholder="牙医邮箱" clearable  :readonly="ro.yayiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="挂号费用" prop="newMoney">
                       <el-input v-model="ruleForm.newMoney"
                                 placeholder="挂号费用" clearable  :readonly="ro.newMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="挂号费用" prop="newMoney">
                           <el-input v-model="ruleForm.newMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yayiContent"  label="医生介绍" prop="yayiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yayiContent" label="医生介绍" prop="yayiContent">
                            <span v-html="ruleForm.yayiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yayiShanchangContent"  label="擅长" prop="yayiShanchangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yayiShanchangContent" label="擅长" prop="yayiShanchangContent">
                            <span v-html="ruleForm.yayiShanchangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yayiRongyuContent"  label="所获荣誉" prop="yayiRongyuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yayiRongyuContent" label="所获荣誉" prop="yayiRongyuContent">
                            <span v-html="ruleForm.yayiRongyuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    zhiweiTypes: false,
                    yayiContent: false,
                    yayiShanchangContent: false,
                    yayiRongyuContent: false,
                    jinyongTypes: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    yayiUuidNumber: new Date().getTime(),
                    yayiName: '',
                    yayiPhone: '',
                    yayiIdNumber: '',
                    yayiPhoto: '',
                ...
                rules: {
                   ...
                   yayiUuidNumber: [
                              { required: true, message: '牙医编号不能为空', trigger: 'blur' },
                          ],
                   yayiName: [
                              { required: true, message: '牙医姓名不能为空', trigger: 'blur' },
                          ],
                   yayiPhone: [
                              {  required: true, message: '牙医手机号不能为空', trigger: 'blur' },
                   ...
                   yayiIdNumber: [
                              { required: true, message: '牙医身份证号不能为空', trigger: 'blur' },
                   ...
                   yayiPhoto: [
                              { required: true, message: '牙医头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   yayiEmail: [
                              { required: true, message: '牙医邮箱不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yayiContent = _this.ruleForm.yayiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.yayiShanchangContent = _this.ruleForm.yayiShanchangContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.yayiRongyuContent = _this.ruleForm.yayiRongyuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yayiContent = this.ruleForm.yayiContent.replaceAll(this.$base.url,"");
                        this.ruleForm.yayiShanchangContent = this.ruleForm.yayiShanchangContent.replaceAll(this.$base.url,"");
                        this.ruleForm.yayiRongyuContent = this.ruleForm.yayiRongyuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yayi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yayiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
